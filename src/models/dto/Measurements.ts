...
export function instanceOfMeasurements(value: object): value is Measurements {
  if (!("sensorMacAddress" in value) || value["sensorMacAddress"] === undefined)
    return false;
  return true;
}
...
export function MeasurementsFromJSONTyped(
  json: any,
...
export function MeasurementsToJSONTyped(
  ...
  return {
    ...
    measurements:
      value["measurements"] == null
        ? undefined
        : (value["measurements"] as Array<any>).map(MeasurementToJSON),
  };
}
